...
const PERMISSIONS_WITH_CATEGORY: Array<{ name: string; category?: string }> = [
  ...
  { name: 'vouchers:read', category: 'Promotions' },
  { name: 'vouchers:write', category: 'Promotions' },
  { name: 'sales-campaigns:read', category: 'Promotions' },
  { name: 'sales-campaigns:write', category: 'Promotions' },
...
const PERMISSION_NAMES = [
  ...
  'vouchers:read',
  'vouchers:write',
  'sales-campaigns:read',
  'sales-campaigns:write',
  'settings:read',
  'settings:write',
  'emaillogs:read',
  'emaillogs:resend',
